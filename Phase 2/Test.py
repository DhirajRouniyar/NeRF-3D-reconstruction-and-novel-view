...
def main():
    ...
    Model_path = '/home/dhrumil/WPI/Sem2/Computer_Vision/Project2/Nerf/Code/Low_Res/Lego/Trained_Model/WO_PE/model_epoch_8.pt'
    ...
    Test_Path = '/home/dhrumil/WPI/Sem2/Computer_Vision/Project2/Nerf/Datasets/lego/transforms_test.json'
    ...
    for i, data in enumerate(Test_Loader, 0):
        ...
        Loss = Nerf_Loss(Rendered_Image, Images) #added
        psnr = -10. * torch.log10(torch.tensor(Loss)) #added
        
        psnr.append(psnr.numpy())

        # Convert the images to PyTorch tensors
        testimg_tensor = T.ToTensor()(Images)
        rgb_tensor = T.ToTensor()(Rendered_Image)

        # Calculate SSIM
        ssim_value = torchvision.transforms.functional.ssim(testimg_tensor, rgb_tensor)
        ssim.append(ssim_value.numpy())
        ...
        print(i)
    print("Avg PSNR: ", np.mean(psnr))
    print("Avg SSIM: ", np.mean(ssim))
    i = 0
    for G in Generated_Images:
        ...
        plt.savefig('/home/dhrumil/WPI/Sem2/Computer_Vision/Project2/Nerf/Code/Low_Res/Lego/Generated_Images/WO_PE/CKPT_5/Rendered_Image_'+str(i)+'.png', bbox_inches='tight', pad_inches=0, dpi=300)
    ...
    fp_out = "/home/dhrumil/WPI/Sem2/Computer_Vision/Project2/Nerf/Code/Low_Res/WO_PE_Lego.gif"

    fp_in = []

    for i in range(200):
        fp_in.append("/home/dhrumil/WPI/Sem2/Computer_Vision/Project2/Nerf/Code/Low_Res/Lego/Generated_Images/WO_PE/CKPT_5/Rendered_Image_"+str(i)+".png")
